...
* Skills Used: Python, Machine Learning, Data Visualization, Feature Engineering.

* Goal: To provide actionable insights for real estate professionals, developers, buyers, and policymakers while improving the understanding of housing market dynamics.


3. Modeling Mosquito Dynamics and West Nile Virus Presence
...
4. Sentiment Insights for Hospitality Using NLP
...
5. Analyzing US Air Traffic Using SQL
...
* Machine Learning: Regression, Classification, Gradient Boosting, Clustering, NLP.